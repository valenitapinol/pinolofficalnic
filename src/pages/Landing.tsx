    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6 items-center">
            ...
            <Link to="/register" className="bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-700">
              Registrarse
            </Link>
          </nav>
        </div>
      ...
      <section className="bg-gradient-to-br from-red-600 to-red-700 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            La mejor comida típica de Nicaragua directamente a tu puerta. Rápido, confiable y delicioso.
          </p>
          <div className="flex gap-4 justify-center">
            <Link to="/register" className="bg-white text-red-600 px-8 py-3 rounded-full font-bold hover:bg-gray-100 flex items-center gap-2">
              Descargar App <ArrowRight className="w-5 h-5" />
            </Link>
            <button className="border-2 border-white px-8 py-3 rounded-full font-bold hover:bg-red-600">
              Ver restaurantes
            </button>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          <div>
            <h3 className="text-4xl font-bold text-red-600">1,200+</h3>
            <p className="text-gray-600">Pedidos diarios</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-red-600">45+</h3>
            <p className="text-gray-600">Restaurantes asociados</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-red-600">25 min</h3>
            <p className="text-gray-600">Entrega promedio</p>
          </div>
          <div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Llega a más clientes, aumenta tus ventas 30% en promedio.
          </p>
          <button className="bg-red-600 text-white px-8 py-3 rounded-full font-bold hover:bg-red-700">
            Contactar ventas
          </button>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-4">PinolApp</h4>
              <p className="text-gray-400 text-sm">La mejor comida nicaragüense a tu puerta</p>
            </div>
            <div>
            ...
            <div>
              <h4 className="font-bold mb-4">Seguínos</h4>
              <ul className="text-gray-400 text-sm space-y-2">
          ...
          <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
            <p>&copy; 2026 PinolApp. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
